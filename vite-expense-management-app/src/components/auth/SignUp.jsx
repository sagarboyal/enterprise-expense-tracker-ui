  ...
  return (
    <div className='flex flex-1 flex-col md:flex-row min-h-screen'>
      ...
      <div className='bg-black text-white flex flex-col justify-center items-start px-20 py-5 md:w-1/2 min-h-screen'>
        <h1 className='font-[Poppins] text-3xl font-extrabold lg:text-5xl text-gray-100 mb-4'>
          Manage Enterprise Expenses Effortlessly with{" "}
          <span className='text-red-500'>Trex</span>
        </h1>

        <p className='font-[Inter] text-base font-medium lg:text-sm text-gray-300 mb-8 max-w-xl'>
      ...
      {/* Right side */}
      <div className='flex flex-col md:w-1/2 w-full px-3 py-5 font-[Poppins]'>
        <div className='flex flex-1 items-center justify-center'>
          ...
          >
            ...
            <div className='text-center text-sm text-gray-600'>
              ...
              <a
                href='/login'
                className='text-black font-medium hover:underline hover:text-silver-500 transition duration-200'
              >
                Sign in &rarr;
              </a>
            </div>
